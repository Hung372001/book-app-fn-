  ...
  return (
    <div className=" flex relative " id="listBook">
      ...
      >
        ...
        <div
          className={`w-9 h-9 rounded-full flex items-center justify-center  border-[1px] border-black cursor-pointer absolute top-[45%] z-50 left-0 ${
            checkstart ? "hidden" : ""
          }`}
          onClick={handlePrev}
        >
        ...
        <div
          className={`w-9 h-9 rounded-full  flex items-center justify-center border-[1px] border-black cursor-pointer absolute top-[45%] z-50 right-0  ${
            checkEnd ? "hidden" : ""
          }`}
          onClick={handleNext}
        >
